const App = {
    ...
    Radio: {
        Play: () => {
            if (Radio.Stream()) {
                document.getElementById("play-btn").querySelector("img").src = "https://kaatan.azurewebsites.net/files/pause.svg";
                document.getElementById("paused").style.display = "none";
                document.getElementById("playing").style.display = "block";
            } else {
                document.getElementById("play-btn").querySelector("img").src = "https://kaatan.azurewebsites.net/files/play.svg";
        ...
        Mute: () => {
            if (Radio.Volume == 1) {
                Radio.Mute(true);
                document.getElementById("mute-btn").querySelector("img").src = "https://kaatan.azurewebsites.net/files/mute.svg";
            } else {
                Radio.Mute(false);
                document.getElementById("mute-btn").querySelector("img").src = "https://kaatan.azurewebsites.net/files/volume.svg";
            }
        },
    },
    About: async () => {
